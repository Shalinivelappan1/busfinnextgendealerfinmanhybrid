...
### உங்கள் டீலர்ஷிப் தற்போது லாபத்தில் உள்ளது

ஒரு பேக்கிற்கு நிகர லாபம்:

₹{net_profit_per_bag:.2f}
...
தற்போதைய அமைப்பில் டீலர்ஷிப் நஷ்டத்தில் இயங்குகிறது.

ஒரு பேக்கிற்கு நஷ்டம்:

₹{abs(net_profit_per_bag):.2f}

""")

    st.info(f"""

### டீலர் பொருளாதாரத்தின் முக்கிய உண்மைகள்

✅ பில்லிங் விலை = ₹{billing_price:.2f}

✅ மொத்த ஊக்கத்தொகை = ₹{total_incentives:.2f}

✅ உண்மையான செலவு = ₹{effective_cost:.2f}

✅ சந்தை விற்பனை விலை = ₹{selling_price:.2f}

✅ வர்த்தக மார்ஜின் = ₹{trading_margin:.2f}
...
உண்மையான லாபத்தை உருவாக்குகின்றன.
...
வாடிக்கையாளர்களுக்கு அதிக கிரெடிட் வழங்கப்பட்டுள்ளது.

பணம் வசூலாக தாமதமாகலாம்.

இதனால்:

• Cash Flow பாதிக்கப்படும்

• Working Capital அதிகரிக்கும்

• கடன் தேவையும் அதிகரிக்கலாம்
...
### இருப்பு (Inventory) எச்சரிக்கை

அதிகமான இருப்பு வைத்திருப்பது

அதிகமான பணத்தை முடக்கி வைப்பதற்கு சமம்.

Inventory என்பது

சிமெண்ட் மூட்டைகள் அல்ல.
...
"விற்பனை செய்வது நல்ல டீலர்.

பணத்தை வசூலிப்பது சிறந்த டீலர்.

பணப்புழக்கத்தை நிர்வகிப்பது வெற்றிகரமான டீலர்."
---
""")
